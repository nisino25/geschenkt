    ...
    <div class="controller">
      <template v-if="winner == ''">
        ...
        <div v-else>
          ...
          <button :style="[myPlayer?.balance <= 0 ? 'background-color:GoldenRod; opacity: 0.4' : 'background-color:GoldenRod;' ]" class="button" :disabled="(myPlayer.balance<= 0)" @click="pay()" style=";">Pay</button> &nbsp;
